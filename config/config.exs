...
config :uba9_import, DI.Repo,
  adapter: Ecto.Adapters.MySQL,
  database: "uba9",
  username: "uba9",
  password: "meek.hoo.bold.santi",
  hostname: "localhost"

config :uba9_import, ecto_repos: [DI.Repo]
...
#
#     config :uba9_import, key: :value
#
# and access this configuration in your application as:
#
#     Application.get_env(:uba9_import, :key)
#
